        ...
        <div className='details-body'>
            ...
            <div className='details-four-layout'>
                <div className='details-four-layout-item'>
                    <div className='details-four-layout-item-icon'>
                        ...
                        <circle cx="15" cy="15" r="15" fill="#14BDBD" fill-opacity="0.25"/>
                        <path d="M11.6637 19.8949L8.0146 16.0678C7.60798 15.6414 6.96157 15.6414 6.55496 16.0678C6.14835 16.4943 6.14835 17.1722 6.55496 17.5987L10.9234 22.1802C11.3301 22.6066 11.9869 22.6066 12.3935 22.1802L23.445 10.6006C23.8517 10.1742 23.8517 9.49627 23.445 9.06983C23.0384 8.64339 22.392 8.64339 21.9854 9.06983L11.6637 19.8949Z" fill="#14BDBD"/>
                        </svg>
                    </div>
                ...
                <div className='details-four-layout-item'>
                    ...
                    <div className='details-four-layout-item-coulumn' onClick={() => router.push('/nanny/matching')}>
            ...
            <div className='details-four-layout'>
                <div className='details-four-layout-item'>
                    <div className='details-four-layout-item-icon'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="24" viewBox="0 0 26 24" fill="none">
                            <path d="M13 5.56508C10.3333 -0.694174 1 -0.0275066 1 7.97253C1 15.9726 13 22.6395 13 22.6395C13 22.6395 25 15.9726 25 7.97253C25 -0.0275066 15.6667 -0.694174 13 5.56508Z" fill="#E3838E" stroke="#E3838E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <div className='details-four-layout-item-coulumn' onClick={() => router.push('/nanny/favorite')}>
                ...
                <div className='details-four-layout-item'>
                    ...
                    <div className='details-four-layout-item-coulumn' onClick={() => router.push('/nanny/history')}>
