      ...
      <div className="profileSection">
        ...
        <div className='profile-section'>
            ...
            <div className='part'>
                ...
                <span className='part-subTitle'>{orderInfo.gender === 'male' ? '男' : '女'}</span>
            </div>
        </div>
        ...
        <div className="tabs">
          ...
          <div className="tab-content">
              ...
              <span className='tab-subTitle'>
                {orderInfo.scenario === 'infantCareCenter' ? '定點托育' : '到宅托育'}
              </span>
          </div>
        </div>
          ...
          <div className="iconNav">
            {['1', '2', '3', '4', '5', '6'].map((number) => (
                <div key={number} style={{
                    ...
                    <div className={`iconStyle ${orderInfo.hope?.includes(number) ? 'active' : 'inactive'}`}>
                        {number === '1' ? (
                    ...
                    <span className={`fontSpan ${orderInfo.hope?.includes(number) ? 'active' : 'inactive'}`}>
                        {serviceNames[number]}
                    </span>
                </div>
            ))}
