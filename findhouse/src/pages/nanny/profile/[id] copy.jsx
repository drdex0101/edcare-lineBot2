...
export default function ProfilePage() {
  ...
  const fetchNannyInfo = async () => {
    setIsLoading(true);
    try {
      const response = await fetch(`/api/nanny/getNannyInfo?id=4`, {
        method: 'GET',
        headers: {
      ...
      <div className="profileSection">
        ...
        <div className='profile-section'>
            <div className='part'>
                ...
                <span className='part-subTitle'>{nannyInfo.experienment}年</span>
            </div>
            <div className='part'>
                <span className='part-title'>年紀</span>
                <span className='part-subTitle'>{nannyInfo.age}歲</span>
            </div>
            <div className='part'>
                <span className='part-title'>托育</span>
                <span className='part-subTitle'>{nannyInfo.kidCount}位</span>
            </div>
        </div>
        ...
        <div className="imageSection">
          ...
          <div className="carousel">
            <img
              src={nannyInfo.environmentPic[currentImageIndex]}
