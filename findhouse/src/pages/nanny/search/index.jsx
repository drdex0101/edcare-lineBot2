  ...
  const fetchOrderInfoList = async (page = 0, pageSize = 5, keywords) => {
    ...
    try {
      const response = await fetch(
        `/api/order/getOrderInfoList?page=${page}&pageSize=${pageSize}&keywords=${keywords}`,
        {
          method: "GET",
          headers: {
                  ...
                  >
                    ...
                    <div style={styles.scoreLayout}>
                      ...
                      <div style={styles.iconLayout}>
                        ...
                        >
                          <path
                            d="M12 4.5C12 3.3125 11.0145 0.5 9.461 0.5C7.93 0.5 7 3.2785 7 4.5C7 5.707 7.8605 6.717 9 6.9495V12.5H10V6.9495C11.1395 6.717 12 5.7075 12 4.5ZM8 7.6615C6.8045 7.0915 6 5.869 6 4.5C6 3.8585 6.2115 2.781 6.6635 1.7895C6.1425 1.6055 5.584 1.5 5 1.5C2.2385 1.5 0 3.7385 0 6.5C0 9.2615 2.2385 11.5 5 11.5C6.127 11.5 7.1635 11.1225 8 10.493V7.6615ZM5.5 6.707L3.8535 8.3535L3.1465 7.6465L4.5 6.293V4H5.5V6.707Z"
                            fill="#E3838E"
                          />
                        </svg>
                      </div>
