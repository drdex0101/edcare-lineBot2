...
const ApplicationPage = () => {
  ...
  const handleFilterChange = (regions,locations, sorts) => {
    ...
    fetchOrderInfoList(currentPage, pageSize, keywords, locations, selectedSort); // Fetch nanny info with updated filters
  };
  ...
  const fetchOrderInfoList = async (page = 0, pageSize = 5, keywords,searchLocation,sort) => {
