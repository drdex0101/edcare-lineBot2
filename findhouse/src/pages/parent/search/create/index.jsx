...
const ApplicationPage = () => {
  ...
  const handleNextClick = () => {
    router.push("/parent/search/create/choose"); // 替换 '/next-page' 为你想要跳转的路径
  };
        ...
        <div style={styles.contentLayout}>
          ...
          <div style={styles.lawLayout}>
            <div style={styles.imgLayout}>
              <img src="/orderCreate.png" alt="Description of image F" />
            </div>
          </div>
          <div style={styles.buttonLayout}>
            <button style={styles.nextBtn} onClick={handleNextClick}>
              ...
              <span style={styles.nextBtnFont}>建立托育資料</span>
            </button>
...
const styles = {
  nextVerifyBtn: {
    ...
    gap: "8px",
    borderRadius: "6px",
    background: "var(---Error-Container, #FFB3B3)",
    border: "none",
  },
  nextBtnFont: {
