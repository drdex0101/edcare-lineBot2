                    ...
                    <div key={index} style={styles.orderItem}>
                      ...
                      <div style={styles.orderInfo}>
                        ...
                        <div style={{ display: 'flex', gap: '5px',flexDirection:'column'}}>
                              ...
                              {order.choosetype === 'suddenly' ? careTypeData.start_date.slice(0, 10) + '~' + careTypeData.end_date.slice(0, 10) : 
                               order.choosetype === 'longTerm' ? careTypeData.weekdays.join(', ') + ' ' + careTypeData.care_time : ''}
                              </span>
                        </div>
                      </div>
                    </div>
