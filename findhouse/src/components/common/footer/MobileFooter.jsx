    ...
    <div className="row">
      <div>
        <div className="footer_menu_widget">
          <ul >
            <li style={{color:'white'}}>代客採買/專業配送</li>
            <li style={{color:'white'}}>蔬果批發.零售/各類蔬果加工</li>
            ...
            <li style={{color:'white'}} ><img src="/assets/images/icon/placeholder.png" alt="placeholder" className='icon' />
            <a href="#">高雄市左營區菜公路143號</a></li>
            <li style={{color:'white'}}>(一二三)統編:10204088</li>
            <li style={{color:'white'}}>(大方)統編:82750613</li>
          </ul>
          <div style={{paddingRight:20}}><img src="qrcode.png" height={100} width={100}  alt="qrcode"/></div>
        </div>
      </div>
    </div>
  );
