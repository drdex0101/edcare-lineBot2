    ...
    <div className="setting-container">
      ...
      {isOpen && (
        <div ref={settingPopupRef} className="setting-popup">
          <div
            onClick={() => router.push("/nanny/myAccount/member")}
          ...
          >
            <div className="setting-item-icon">
              ...
              >
                <path
                  opacity="0.4"
                  d="M16 0H4C1.79086 0 0 1.79086 0 4V16C0 17.8642 1.27532 19.4306 3.00111 19.8743C3.32039 19.9563 3.6551 20 4 20H16C16.3449 20 16.6796 19.9563 16.9989 19.8743C18.7247 19.4306 20 17.8642 20 16V4C20 1.79086 18.2091 0 16 0Z"
                  fill="#28303F"
                />
                <circle
                  cx="3"
                ...
                />
                <path
                  d="M3.99889 20H15.9989C16.3438 20 16.6785 19.9563 16.9978 19.8743C16.9307 16.0663 13.8229 13 9.99889 13C6.1749 13 3.06707 16.0663 3 19.8743C3.31929 19.9563 3.65399 20 3.99889 20Z"
                  fill="#28303F"
                />
              </svg>
            </div>
            <span className="setting-item-font">會員資料</span>
          </div>
          <div
          ...
          >
            <div className="setting-item-icon">
              ...
              >
                <g clip-path="url(#clip0_634_48751)">
                  <path
                    d="M12.5325 12.7275C12.5325 13.0842 12.2883 14.1142 10.0425 15.9608C7.7775 14.1142 7.5325 13.0842 7.5325 12.7275C7.5325 12.16 7.90667 11.6983 8.36583 11.6983C8.825 11.6983 9.19917 12.16 9.19917 12.7275C9.19917 13.1875 9.5725 13.5608 10.0325 13.5608C10.4925 13.5608 10.8658 13.1875 10.8658 12.7275C10.8658 12.16 11.24 11.6983 11.6992 11.6983C12.1583 11.6983 12.5325 12.16 12.5325 12.7275ZM19.1675 9.16667V15.8333C19.165 18.1333 17.3008 19.9975 15.0008 20H5C2.7 19.9975 0.835833 18.1333 0.833333 15.8333V9.16667C0.833333 8.70667 1.20667 8.33333 1.66667 8.33333H18.3333C18.7933 8.33333 19.1675 8.70667 19.1675 9.16667ZM14.1992 12.7275C14.1992 11.2408 13.0775 10.0317 11.6992 10.0317C11.0592 10.0317 10.475 10.2917 10.0325 10.72C9.59 10.2925 9.00583 10.0317 8.36583 10.0317C6.9875 10.0317 5.86583 11.2408 5.86583 12.7275C5.86583 14.0592 6.8875 15.5392 8.98917 17.2525C9.29167 17.4992 9.6625 17.6225 10.0325 17.6225C10.4025 17.6225 10.7733 17.4992 11.0758 17.2525C13.1775 15.5392 14.1992 14.0592 14.1992 12.7275ZM16.015 0.00416667C15.9542 0.00166667 4.16667 0 4.16667 0C1.865 0 0 1.865 0 4.16667C0 5.54667 1.11917 6.66667 2.5 6.66667H17.5008C18.8167 6.6825 19.9158 5.66583 20.0008 4.3525C20.1008 2.05083 18.3167 0.104167 16.015 0.00416667Z"
                    fill="#FFB3B3"
                  />
                </g>
                <defs>
            ...
            <span className="setting-item-font">媒合訂單</span>
          </div>
          <div
          ...
          >
            <div className="setting-item-icon">
              ...
              >
                <path
                  d="M11.5 4.50475C9.27778 -0.71129 1.5 -0.155735 1.5 6.51097C1.5 13.1777 11.5 18.7334 11.5 18.7334C11.5 18.7334 21.5 13.1777 21.5 6.51097C21.5 -0.155735 13.7222 -0.71129 11.5 4.50475Z"
                  fill="#E3838E"
                  stroke="#E3838E"
